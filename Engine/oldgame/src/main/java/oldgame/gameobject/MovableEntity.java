...
public abstract class MovableEntity extends Entity
{
    ...
    public MovableEntity(Vector3f position, float rotation, float scale, boolean hasGravity, GameObject gameObjectType)
    {
     ...
     */
    public abstract void calculateMotion(OrthographicCamera camera, float deltaTime);
     ...
     * @param deltaTime the delta time gotten from the timing circuit in Application.
     */
    protected void calculateGravity(float compensation, float deltaTime)
    {
        if (hasGravity)
        {
