...
public class Fonts {
    ...
    public static final Font ROBOTO_REGULAR = new Font("fonts/Roboto-Regular.ttf", 100, new Vector3f(0.0f, 0.0f, 1.0f));
    public static final Font THE_BOLD_FONT = new Font("fonts/theboldfont.ttf", 80, new Vector3f(0.0f, 0.0f, 1.0f));
    public static final Font VCR_OSD_MONO_1 = new Font("fonts/VCR_OSD_MONO_1.001.ttf", 80, new Vector3f(0.0f, 0.0f, 1.0f));
