...
public class DockspaceApplication extends Application
{
    ...
    protected void clientInit(Window window)
    {
        ...
        dockspace.addPanel(new DockablePanel(new Vector2f(500f, 300f), new Vector2f(300f, 200f), new Vector4f(0.3f, 0.8f, 0.2f, 1f)));
        dockspace.addPanel(new DockablePanel(new Vector2f(500f, 300f), new Vector2f(300f, 200f), new Vector4f(0.2f, 0.3f, 0.8f, 1f)));
