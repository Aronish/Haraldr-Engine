...
public class TextLabel
{
    ...
    public void render()
    {
        ...
        Shader.TEXT.bind();
        Shader.TEXT.setMatrix4f(Matrix4f.createTranslate(position), "model");
        Shader.TEXT.setMatrix4f(Matrix4f.pixelOrthographic, "projection");
        Shader.TEXT.setVector4f(color, "u_Color");
        font.bind(0);
        textMesh.bind();
