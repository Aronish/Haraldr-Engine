...
public class Font
{
    ...
    public Font(String fontPath, int fontHeight, Vector3f fontColor)
    {
        ...
        fontBitmapWidth = Math.round(512 * Window.contentScaleX);
        fontBitmapHeight = Math.round(512 * Window.contentScaleY);
    ...
    private STBTTBakedChar.Buffer init() {
        ...
        stbtt_BakeFontBitmap(ttfFont, fontHeight * Window.contentScaleY, bitmap, fontBitmapWidth, fontBitmapHeight, 32, cdata);
