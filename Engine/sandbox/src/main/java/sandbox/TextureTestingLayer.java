...
public class TextureTestingLayer extends Layer
{
    ...
    private final Spotlight spotlight = new Spotlight(new Vector3f(1f), new Vector3f(0f, 0f, 1f), new Vector3f(0.8f, 0.2f, 0.3f), 30f, 40f);
    ...
    public void onUpdate(@NotNull Window window, float deltaTime)
    {
        ...
        spotlight.setDirection(Vector3f.normalize(new Vector3f(cos, 0f, sin)));
